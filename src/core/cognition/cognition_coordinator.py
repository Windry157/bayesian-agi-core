...
class CognitionCoordinator:
    ...
    def _fuse_decisions(self, system1_decision: Dict[str, Any], system2_decision: Dict[str, Any]) -> Dict[str, Any]:
        """融合两个系统的决策
        ...
        # 融合置信度
        fused_decision["confidence"] = (system1_weight * system1_decision["confidence"] + 
                                       system2_weight * system2_decision["confidence"]) / total_weight
