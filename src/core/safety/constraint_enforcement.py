...
class ConstraintEnforcementModule:
    ...
    def check_constraints(self, input_text: str, output_text: str) -> Dict[str, Any]:
        ...
        for topic, config in self.sensitive_topics.items():
            if self._contains_patterns(
                input_text, config["patterns"]
            ) or self._contains_patterns(output_text, config["patterns"]):
        ...
        # 所有检查通过
        return {"passed": True, "reason": "无问题", "alternative_response": None}
    ...
    def _contains_harmful_content(self, text: str) -> bool:
        ...
        harmful_patterns = [
            ...
            r"how to hurt yourself",
            r"how to harm others",
        ]
    ...
    def add_sensitive_topic(self, topic: str, patterns: List[str], response: str):
        ...
        Args:
            ...
            response: 响应文本
        """
        self.sensitive_topics[topic] = {"patterns": patterns, "response": response}
